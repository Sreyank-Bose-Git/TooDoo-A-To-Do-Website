...
function addElement() {
    if(select.value == "CheckList") {
        ...
        if (customtext != null) {  
            ...
            document.getElementById("opt1").innerHTML += `<option value="${chknum}">${customtext}</option>`;
            chknum *= 10;
        }
    }
    if(select.value == "Text") {
        ...
        if (customtext != null) {  
            form.innerHTML += `<label style="" id="txtl${txtnum}">${customtext}</label>
            ...
            document.getElementById("opt2").innerHTML += `<option value="${txtnum}">${customtext}</option>`;
            txtnum *= 9;
        }
    }
}
